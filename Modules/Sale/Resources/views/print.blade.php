...
<div style="max-width:400px;margin:0 auto">
    <div id="receipt-data">
        <div class="centered">
            <img width="180" src="{{ public_path('img/fullLogo.png') }}" alt="Logo">
            <p style="font-size: 11px;line-height: 15px;margin-top: 0">
                <b>fourtPOS@gmail.com</b>, 022 8212 717 0875
                <br>Jl. Pasir Kaliki No.25, Arjuna, Kecamatan Andir, Kota Bandung
            </p>
        </div>
        <p>
            ...
            <tbody>
                <tr style="background-color:#ddd;">
                    <td class="centered" style="padding: 5px;">
                        Total Bill: {{ format_currency($sale->total_amount) }}
                    </td>
                    <td class="centered" style="padding: 5px;">
                        No Meja: {{ $sale->no_table }}
                    </td>
                </tr>
